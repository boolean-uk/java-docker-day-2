...
import com.booleanuk.api.inserts.Inserts;
import com.booleanuk.api.model.ERole;
import com.booleanuk.api.model.Role;
import com.booleanuk.api.model.User;
import com.booleanuk.api.repository.RoleInsertRepository;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signupRequest) {
        if(this.roleRepository.findAll().size() < 3) {
            ...
            /*roleInsertRepository.insertWithQuery(new Role(ERole.ROLE_USER));
            roleInsertRepository.insertWithQuery(new Role(ERole.ROLE_MODERATOR));
            roleInsertRepository.insertWithQuery(new Role(ERole.ROLE_ADMIN));*/
        }
